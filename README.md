...
| keycloak.server.endpoint                              | Keycloak path + /realms/<KEYCLOAK_REALM>                                                                                                                                    | Yes                          |
| keycloak.server.client                                | Keycloak video API client, for authentication when making internal service-to-service requests.                                                                             | Yes                          |
| keycloak.server.client.secret                         | Keycloak video API client secret, for authentication when making internal service-to-service requests.                                                                      | Yes                          |
