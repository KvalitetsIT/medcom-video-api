...
INSERT INTO scheduling_info (id, uuid, host_pin, guest_pin, vmravailable_before, vmrstart_time, max_participants, end_meeting_on_end_time, meetings_id, uri_with_domain, uri_without_domain, scheduling_template_id, provision_status, provision_status_description, provision_timestamp,  provisionvmrid, portal_link, ivr_theme, created_by, created_time, updated_by, updated_time, organisation_id, pool_overflow, vmr_type, host_view, guest_view, vmr_quality, enable_overlay_text, guests_can_present, force_presenter_into_main, force_encryption, mute_all_guests)
VALUES (204, (select uuid from meetings where id = 5) , 1001, 2001, 15, '2018-12-02 14:45:00', 10, 1, 5, '1233@test.dk', '1233', 1, 'AWAITS_PROVISION', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1233@test.dk&pin=2001&start_dato=2018-12-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 101, '2018-09-02 15:00:00', 101, '2018-09-02 15:00:00', 6, 0, 'conference', 'one_main_seven_pips', 'one_main_seven_pips', 'hd', true, true, true, false, false);

INSERT INTO scheduling_info (id, uuid, host_pin, guest_pin, vmravailable_before, vmrstart_time, max_participants, end_meeting_on_end_time, meetings_id, uri_with_domain, uri_without_domain, scheduling_template_id, provision_status, provision_status_description, provision_timestamp,  provisionvmrid, portal_link, ivr_theme, created_by, created_time, updated_by, updated_time, organisation_id, pool_overflow, vmr_type, host_view, guest_view, vmr_quality, enable_overlay_text, guests_can_present, force_presenter_into_main, force_encryption, mute_all_guests)
VALUES (206, (select uuid from meetings where id = 6) , 1001, 2001, 15, '2018-10-02 14:45:00', 10, 1, 6, '1236@test.dk', '1236', 1, 'AWAITS_PROVISION', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1236@test.dk&pin=2001&start_dato=2018-10-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 104, NULL, NULL, NULL, 5, 0, 'conference', 'one_main_seven_pips', 'one_main_seven_pips', 'hd', true, true, true, false, false);
...
VALUES (207, 1001, 2001, 15, '2018-10-02 14:45:00', 10, 1, '1236@test.dk', '1237', 1, 'PROVISIONED_OK', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1236@test.dk&pin=2001&start_dato=2018-10-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 104, NULL, NULL, NULL, 7, '31293b98-0c51-447c-b10b-1886ab095450', 0, 'conference', 'one_main_seven_pips', 'one_main_seven_pips', 'hd', true, true, true, false, false);

INSERT INTO scheduling_info (id, uuid, host_pin, guest_pin, vmravailable_before, vmrstart_time, max_participants, end_meeting_on_end_time, meetings_id, uri_with_domain, uri_without_domain, scheduling_template_id, provision_status, provision_status_description, provision_timestamp,  provisionvmrid, portal_link, ivr_theme, created_by, created_time, updated_by, updated_time, organisation_id, pool_overflow, vmr_type, host_view, guest_view, vmr_quality, enable_overlay_text, guests_can_present, force_presenter_into_main, force_encryption, mute_all_guests)
VALUES (208, (select uuid from meetings where id = 8) , 1001, 2001, 15, '2019-10-02 14:45:00', 10, 1, 8, '1238@test.dk', '1238', 1, 'PROVISIONED_OK', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1238@test.dk&pin=2001&start_dato=2019-10-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 104, NULL, NULL, NULL, 5, 0, 'conference', 'one_main_seven_pips', 'one_main_seven_pips', 'hd', true, true, true, false, false);

INSERT INTO scheduling_info (id, uuid, host_pin, guest_pin, vmravailable_before, vmrstart_time, max_participants, end_meeting_on_end_time, meetings_id, uri_with_domain, uri_without_domain, scheduling_template_id, provision_status, provision_status_description, provision_timestamp,  provisionvmrid, portal_link, ivr_theme, created_by, created_time, updated_by, updated_time, organisation_id, pool_overflow, vmr_type, host_view, guest_view, vmr_quality, enable_overlay_text, guests_can_present, force_presenter_into_main, force_encryption, mute_all_guests)
VALUES (209, null, 1001, 2001, 15, '2020-10-02 14:45:00', 10, 1, null, '1239@test.dk', '1239', 1, 'PROVISIONED_OK', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1238@test.dk&pin=2001&start_dato=2019-10-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 104, NULL, NULL, NULL, 5, 0, 'conference', 'one_main_seven_pips', 'one_main_seven_pips', 'hd', true, true, true, false, false);

INSERT INTO scheduling_info (id, uuid, host_pin, guest_pin, vmravailable_before, vmrstart_time, max_participants, end_meeting_on_end_time, meetings_id, uri_with_domain, uri_without_domain, scheduling_template_id, provision_status, provision_status_description, provision_timestamp,  provisionvmrid, portal_link, ivr_theme, created_by, created_time, updated_by, updated_time, organisation_id, reservation_id, pool_overflow, vmr_type, host_view, guest_view, vmr_quality, enable_overlay_text, guests_can_present, force_presenter_into_main, force_encryption, mute_all_guests)
VALUES (210, null, 1001, 2001, 15, '2020-10-02 14:45:00', 10, 1, null, '1240@test.dk', '1240', 1, 'PROVISIONED_OK', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1238@test.dk&pin=2001&start_dato=2019-10-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 104, NULL, NULL, NULL, 5, '1331e914-9488-482d-9d9e-d1302c44a1de', 0, 'conference', 'one_main_seven_pips', 'one_main_seven_pips', 'hd', true, true, true, false, false);

INSERT INTO scheduling_info (id, host_pin, guest_pin, vmravailable_before, vmrstart_time, max_participants, end_meeting_on_end_time, uri_with_domain, uri_without_domain, scheduling_template_id, provision_status, provision_status_description, provision_timestamp,  provisionvmrid, portal_link, ivr_theme, created_by, created_time, updated_by, updated_time, organisation_id, uuid, pool_overflow, vmr_type, host_view, guest_view, vmr_quality, enable_overlay_text, guests_can_present, force_presenter_into_main, force_encryption, mute_all_guests)
VALUES (211, 1001, 2001, 15, '2018-10-02 14:45:00', 10, 1, '1241@test.dk', '1241', 1, 'PROVISIONED_OK', 'all ok', null, null, 'https://portal-test.vconf.dk/?url=1236@test.dk&pin=2001&start_dato=2018-10-02T15:00:00', '/api/admin/configuration/v1/ivr_theme/10/', 104, NULL, NULL, NULL, 7, '31293b98-0c51-447c-b10b-1886ab095467', 0, 'lecture', 'one_main_zero_pips', 'four_mains_zero_pips', 'full_hd', false, false, false, true, true);
