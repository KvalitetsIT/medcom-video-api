...
public interface SchedulingTemplateService {
    ...
    SchedulingTemplate createSchedulingTemplate(CreateSchedulingTemplateDto createSchedulingTemplateDto, boolean b) throws PermissionDeniedException;
    ...
    SchedulingTemplate updateSchedulingTemplate(Long id, UpdateSchedulingTemplateDto updateSchedulingTemplateDto) throws PermissionDeniedException, RessourceNotFoundException;

    void deleteSchedulingTemplate(Long id) throws PermissionDeniedException, RessourceNotFoundException;

    SchedulingTemplate getSchedulingTemplateInOrganisationTree() throws PermissionDeniedException;
}
