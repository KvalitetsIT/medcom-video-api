...
public class PoolServiceImpl implements PoolService {
    ...
    private void fillPool(PoolInfoDto poolInfoDto) {
        ...
        try {
            MeetingUser meetingUser = meetingUserRepository.findOneByOrganisationCodeAndEmail(poolOrganisation, poolOrganisationUser);
            if (meetingUser == null) {
                meetingUser = new MeetingUser();
                meetingUser.setEmail(poolOrganisationUser);
                meetingUser.setOrganisationCode(poolOrganisation);
